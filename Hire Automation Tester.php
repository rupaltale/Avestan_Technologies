        ...
        <div class="container margin">
             ...
             <div class="container-fluid">
                 <div class="col-md-6 col-lg-7 px-xl-0 text-white">
                     <h1 class="text-capitalize mb-0 text-white"><strong>Hire Highly Skilled &  Experienced Automation Tester Developers</strong></h1>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb_box text-center">
                        <h1 class="breadcrumb-title text-color-primary">Hire Automation Tester</h1><br>
                        <!-- breadcrumb-list start -->
                       <p> Testing, without a doubt has now become a bottle neck when it comes to production process of
                        software application. Since it requires time, patience, man power and money, companies often
                        skip multiple testing procedures in a hurry to get their product in the market.</p> <br>
                        ...
                        <div class="row row-cols-1 row-cols-md-3 g-4">
                            <div class="col">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title">Junior Automation Tester</h5>
                                        <p class="card-text">
                                        <dl style="text-align: justify;">
                                            <dt> Roles and Responsibilities : </dt>


                                            <li> Create automated testes</li>
                                            <li> Be a meaningful part of the software development team</li>
                                            <li> Work with senior testers to create reusable data environment</li>
                                            <li> Advanced knowledge in business applications</li>
                                            <li> Work on automated scripts, back-end scripting and user-interface</li>
                                            <li> Participate in estimation, Agile Scrum ceremonies and backlog grooming
                                            </li>
                                        </dl>
                                        </p>
                                    </div>
                            ...
                            <div class="col">
                                <div class="card h-100">
                                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                                    <div class="card-body">
                                        <h5 class="card-title">Automation Tester</h5>
                                        <p class="card-text">
                                        <dl style="text-align: justify;">
                                            <dt> Roles and Responsibilities :</dt>


                                            <li>Identify the automation feasibility for any project</li>
                                            <li> Select and identify automation test cases</li>
                                            <li> Use test automation guidelines</li>
                                            <li> Facilitate collaboration between testers and developers</li>
                                            <li> Must be able to operate most-modern test automation framework</li>
                                            <li> Design test cases and write test automaton scripts to run automation
                                            </li>
                                            <li> Must be able to develop efficient test automation strategy</li>
                                            <li> Test automation framework design and implementation</li>
                                        </dl>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="col">
                                <div class="card h-100">
                                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                                    <div class="card-body">
                                        <h5 class="card-title">Senior Automation Tester</h5>
                                        <p class="card-text">
                                        <dl style="text-align: justify;">
                                            ...
                                            <li>He/she must have good coding knowledge</li>
                                            <li> Exemplary in automation frameworks</li>
                                            <li> Automation framework design and implementation</li>
                                            <li> Maintain the automation test environment</li>
                                            <li> Write test cases based on user stories</li>
                                            <li>Perform scenario based test execution</li>
                                            <li> While execution, if defect surfaces, report it properly to the
                                                developer</li>
                                            <li> Find solution for issues and good at error handling</li>
                                            <li> Must be able to perform re-testing if necessary</li>
                                            <li> Create project release status</li>
                                            <li> FacebookTwitterEmailShare </li>
                                        </dl>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <!-- <div class="col"> -->
                                <!-- <div class="card h-100"> -->
                                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                                    <!-- <div class="card-body"> -->
                                        <!-- <h5 class="card-title">With Laravel’s unit-testing support, developers need not -->
                                            <!-- have to worry about unexpected bugs and breakdowns. Each unit is thoroughly -->
                                            <!-- tested to be proceeded further.</h5> -->
                                        <!-- <p class="card-text">  -->
                                        <!-- WordPress is used by 26 % of all websites on the internet. Other PHP frameworks occupy a similar role in different verticals. Hire us for the best results</p> -->
                                    <!-- </div> -->
                                <!-- </div> -->
                            <!-- </div> -->
                            <!-- <div class="col"> -->
                                <!-- <div class="card h-100"> -->
                                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                                    <!-- <div class="card-body"> -->
                                        <!-- <h5 class="card-title">It is having one click, zero-downtime PHP deployment tool -->
                                            <!-- named Envoyer helping developers to deploy updated code with almost zero -->
                                            <!-- downtime.</h5> -->
                                        <!-- <p class="card-text"> -->
                                        <!-- Enable your web app to go through our extensive QA testing and maintenance phase, and you'll be able to stand out from the crowd.</p> -->
                                    <!-- </div> -->
                                <!-- </div> -->
                            <!-- </div> -->
                            <!-- <div class="col"> -->
                                <!-- <div class="card h-100"> -->
                                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                                    <!-- <div class="card-body"> -->
                                        <!-- <h5 class="card-title">Our laravel developers understand your vision and craft -->
                                            <!-- solution using model view controller architecture enriched with highly -->
                                            <!-- reliable constitutive features.</h5> -->
                                        <!-- <p class="card-text"> -->
                                        <!-- All IT solution generally requires maintenance. Hire us for maintenance and support 24 hours a day, 7 days a week so you can live a stress-free life.</p> -->
                                    <!-- </div> -->
                                <!-- </div> -->
                            <!-- </div> -->
                        <!-- </div> -->
