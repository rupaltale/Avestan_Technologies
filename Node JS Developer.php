...
<body>
        ...
        <div class="container margin">
             ...
             <div class="container-fluid">
                 <div class="col-md-6 col-lg-7 px-xl-0 text-white">
                     <h1 class="text-capitalize mb-0 text-white"><strong>Hire Highly Skilled & Experienced Node JS Developers</strong></h1>
                   ...
                   <div class="col-md-6 col-lg-5 ps-lg-5 text-center dform">
                     ...
                     <form action="insertdata26.php" method="post">
 ...
 <!--====================  End of Ragistration area  ====================-->
        ...
        <div style="margin:20px ;" class="breadcrumb-area">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb_box text-center">
                            <h1 class="breadcrumb-title text-color-primary">Hire Node JS Developer
                            </h1>
                            <!-- breadcrumb-list start -->
                            <p style="text-align: justify;">We are one of the leading Nodejs development companies. So,
                                leverage our services and get
                                fast, dynamic & scalable real time Nodejs development services.</p> <br>
                            ...
                            <div class="row row-cols-1 row-cols-md-3 g-4">
                                <div class="col">
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title">Node.js Web Application Development</h5>
                                            <p class="card-text" style="text-align: justify;">
                                                Nodejs application development permits using Javascript for both front &
                                                back end development, allowing our Nodejs developers to deliver
                                                extensive
                                                solutions for different industries.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="card h-100">
                                        <!-- <img src="..." class="card-img-top" alt="..."> -->
                                        <div class="card-body">
                                            <h5 class="card-title">Node.js Social Web Application Development</h5>
                                            <p class="card-text" style="text-align: justify;">
                                                Node.js. has various advantages like blazing-fast routing with a secure
                                                authentication and scalability factor, which allows our Nodejs
                                                developers to
                                                make your Social Media platform more robust and secure.
                                ...
                                <div class="col">
                                    <div class="card h-100">
                                        <!-- <img src="..." class="card-img-top" alt="..."> -->
                                        <div class="card-body">
                                            <h5 class="card-title">Node.js eCommerce Development</h5>
                                            <p class="card-text" style="text-align: justify;">

                                                Node.js is considered as one of the best JavaScript frameworks for
                                                eCommerce
                                                development which enables us to gain expertise in providing the best
                                                eCommerce development and CMS solutions for all your business needs.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="card h-100">
                                        <!-- <img src="..." class="card-img-top" alt="..."> -->
                                        <div class="card-body">
                                            <h5 class="card-title">Node.js Interactive UI/UX Development</h5>
                                            <p class="card-text" style="text-align: justify;">

                                                With the help of some of the most amazing features that Nodejs provides,
                                                our
                                                Node js programmers deliver some of the most unique and intuitive UI/UX
                                ...
                                <div class="col">
                                    <div class="card h-100">
                                        <!-- <img src="..." class="card-img-top" alt="..."> -->
                                        <div class="card-body">
                                            <h5 class="card-title">Node.js Support and Maintenance</h5>
                                            <p class="card-text" style="text-align: justify;">

                                                We provide convenient & affordable 24/7 support and maintenance
                                                services,
                                                online ticket resolving, and seamless post-development support to all
                                                our
                                                customers.</p>
                                        </div>
                                    </div>
                                ...
                                <div class="col">
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text" style="text-align: justify;">
                                                We at Avestan Technologies offer best practices in application design
                                                and
                                                Nodejs Application development. Therefore, we offer customised node js
                                                web
                                                development services to meet your business requirements.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <li class="breadcrumb-item"><a href="index.php">Elements</a></li>
                            <li class="breadcrumb-item active">Dividers</li>
                        </ul> -->
                            <!-- breadcrumb-list end -->
                        </div>
                    </div>
        ...
        <div style="margin:20px ;" class="breadcrumb-area">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb_box text-center">
                            ...
                            <!-- breadcrumb-list start -->
                            <p>We are one of the leading Nodejs development companies. So, leverage our services and get
                                fast, dynamic & scalable real time Nodejs development services.</p> <br>
                        </div>
                    </div>
                </div>
         ...
         <div class="card-group">
            <div class="card">
                <!-- <img src="..." class="card-img-top" alt="..."> -->
                <div class="card-body">
                    <h5 class="card-title">Offshore Developer</h5>
                    <p class="card-text">
                        We will provide you with a versatile team of our experienced offshore eCommerce consultants and
                        Node js developers who will help you in expanding the reach of your organization by aligning the
                        processes with your business goals.</p>
                    <a class="btn btn-primary" href="contact-us.php" role="button">HIRE</a>
            ...
            <div class="card">
                <!-- <img src="..." class="card-img-top" alt="..."> -->
                <div class="card-body">
                    <h5 class="card-title">Onsite Developer</h5>
                    <p class="card-text">
                        Our existing clients are very satisfied with the work of our onsite Node js developers. On the
                        basis of your requirements, you can hire our onsite Nodejs developers on contract and start
                        working with them at your preferred location.
                    </p>
                    <a class="btn btn-primary" href="contact-us.php" role="button">HIRE</a>
                    <!-- <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p> -->
                </div>
            ...
            <div class="card">
                <!-- <img src="..." class="card-img-top" alt="..."> -->
                <div class="card-body">
                    <h5 class="card-title">Hybrid Developer</h5>
                    <p class="card-text">
                        We provide a flexible & budget-friendly hybrid delivery model, under which we combine the
                        expertise of our onsite & offshore node js web development teams. This allows us to distribute
                        the work as per your expectations and requirements.</p>
                        <a class="btn btn-primary" href="contact-us.php" role="button">HIRE</a>
                    <!-- <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p> -->
                </div>
            </div>
