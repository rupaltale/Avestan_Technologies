        ...
        <div class="container margin">
             ...
             <div class="container-fluid">
                 <div class="col-md-6 col-lg-7 px-xl-0 text-white">
                     <h1 class="text-capitalize mb-0 text-white"><strong>Hire Highly Skilled &  Experienced Java Developers</strong></h1>
                   ...
                   <div class="col-md-6 col-lg-5 ps-lg-5 text-center dform">
                     ...
                     <form action="insertdata9.php" method="post">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb_box text-center">
                        <h1 class="breadcrumb-title text-color-primary"> Hire Java Developer</h1><br>
                        <!-- breadcrumb-list start -->
                        <p>As Java gains acclaim for building productive and secure applications for businesses, its demand has been increasing at a rapid pace. Are you thinking of investing in a Java-based application but are not sure where to get the right development expertise? We, at Avestan Technologies, bring extensive Java expertise at your doorstep by offering the services of dedicated Java developers</p>
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            ...
                                            End-to-end applications that enhance operational efficiency and drive automation in industrial processes</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card h-100">
                                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                                    <div class="card-body">
                                        <h5 class="card-title">Retail and E-commerce</h5>
                                        <p class="card-text">

                                            
Advanced solutions that yield higher ROI and improve revenues for retail and e-commerce enterprises
...
Customized healthcare applications that set new standards in patient care and take it to the next level</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            ...
                                            Secure and result-oriented banking and finance applications that enhance customer satisfaction manifold</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card h-100">
                                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                                    <div class="card-body">
                                        <h5 class="card-title">Travel and Tourism</h5>
                                        <p class="card-text">


                                            
Feature-rich travel and tourism solutions that are capable of transforming travel experiences forever
...
Innovative Java-based applications that take digital education and e-learning beyond the traditional LMS</p>
                                    </div>
                                </div>
                            </div>
                        </div>
