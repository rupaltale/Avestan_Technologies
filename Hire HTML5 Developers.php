...
<!-- Mirrored from htmldemo.net/mitech/case-studies.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Aug 2022 14:10:56 GMT -->
...
<head>
    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
        ...
        <!-- Favicon -->
    <link rel="icon" href="assets/img/favicon at.jpg">
...
<body>
    ...
    <div class="container-fluid bgcolor">
        <div class="container margin">
             <div class="row gy-3">
             <div class="container-fluid">
                 <div class="col-md-6 col-lg-7 px-xl-0 text-white">
                     <h1 class="text-capitalize mb-0 text-white"><strong>Hire Highly Skilled &  Experienced HTML5 Developers</strong></h1>
                   <ul class="list-groups new-banner-list mymenu" >
                     <li class="gitem"><span class="glyphicon glyphicon-ok-circle sitem"></span>Complete Confidentiality Guaranteed</li>
                     <li class="gitem"><span class="glyphicon glyphicon-ok-circle sitem"></span>Standards for High-Quality Coding</li>
                     <li class="gitem"><span class="glyphicon glyphicon-ok-circle sitem"></span>Ensured Timely Communication</li>
                     <li class="gitem"><span class="glyphicon glyphicon-ok-circle sitem"></span>On-Time Delivery</li>
                   </ul>
                   <a href="#" class="btn btn-md white-btn">Get Started 
                     <svg width="9" height="12" viewBox="0 0 9 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                       <path d="M2.01938 0L0.609375 1.41L5.18937 6L0.609375 10.59L2.01938 12L8.01938 6L2.01938 0Z" fill="#222A41"></path>
                       </svg>
                   </a>
     
                 </div>
                   <div class="col-md-6 col-lg-5 ps-lg-5 text-center dform">
                     <h3>Share Details With Us</h3>
                     <p>Fill your requirements to get started!</p>
                     <form action="insertdata7.php" method="post">
       <form class="form-horizontal finput">
         <div class="form-group">
           
           <div class="col-sm-10">
             <input type="text" class="form-control input-lg" id="Inputname" placeholder="Full Name" name="fullname">
           </div>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
           ...
           <div class="col-sm-10">          
             <input type="number" class="form-control input-lg" id="pnumber" placeholder="Phone Number" name="phonenumber">
           </div>
         </div>
         ...
         <div class="form-group">
           ...
           <div class="col-sm-10">       
             <input type="text" class="form-control input-lg" id="ebudget" placeholder="Estimated Budget" name="estimatedbudget">
           </div>
         </div>
         <div class="form-group">
           
           <div class="col-sm-10">       
             <textarea class="form-control" rows="3" id="comment" placeholder="Enter Your Message" name="enteryourmessage"></textarea>
           </div>
         </div>
         
         <div class="form-group">        
           <div class="col-sm-offset-2 col-sm-10">
             <input  type="submit" class="btn-md btn-default dbtn" value="SUBMIT">
           </div>
         </div>
       </form>
</form>
 ...
 <!--====================  End of Ragistration area  ====================-->
    ...
    <section style="margin: 30px;">
        ...
        <h1 class="breadcrumb-title text-color-primary">Hire HTML5 Developers</h1><br>
       
    
            
          <p class="lh-sm" style="font-size: 20px; text-align: justify">OrangeMantra has a team of highly experienced HTML5 developer help to transition from
            product-centric to service-driven business models. Hire HTML developers having relevant understanding of high-usability and front-end development techniques.
            Our UI development experts have worked on different industry requirements in the last few years. We create
            solutions that render long-term advantages for businesses. We offer diverse hiring process such as our time
            & material hiring, dedicated team hiring, and fixed cost hiring model. We foster a rich-flexibility through
            our HTML5-based solutions.

            OrangeMantra, a leading digital transformation company offers hire HTML5 developer services to clientele
            across the world. We have a reputed team of developers with knowledge to help address their most pressing
            development challenge. Avail our industry-best HTML5 services that help you reach your target audience
            effectively and fulfill all your business expectations. We have HTML5 specialists to collaborate with you to
            offer skills you need from streamlining and managing all systems, and enterprise applications.</p><br>
       
        <h3 class="breadcrumb-title text-color-primary">Hire Html Developers to Elevate Your Business</h3>
        <br>
        <div>
        <div style="float:left; margin-left: 60px;">
        <ul class="list-group" style="text-align:left;font-size:20px;">
            <li class="list-group">
                <label for="101">Agile & adoptive</label>
    ...
    <div style="margin-left: 50px;   "> <img src="assets/images/bg/rjt.jpeg" height="400px" width="400px"></div>
   </div>
</div>
    <br>
    <section style="margin: 30px;">
        <h3 style="text-align: center ;" class="breadcrumb-title text-color-primary">Our HTML5 Development Services</h3>
            <br>
            <p class="lh-sm" style="font-size: 20px; text-align: justify;">With our expertise and experience in HTML5, & CSS our team of developers offer different services
                    in website development</p>
     <div class="row row-cols-1 row-cols-md-2 g-4 " style="margin-top: 80px;color: black; padding: auto;">
            <div class="col">
                <div class="card h-100">

                    <div class="card-body">
                        <h6 style="text-align: center;" class="card-title">HTML5 Application Development</h6>

                        <p class="card-text"> Our HTML developers can offer solutions for web application domains using
                            our HTML5 and CSS expertise. We provide Enterprise HTML 5 application development, HTML 5
                            social media app development, and HTML 5 game development.
            ...
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <h5 style="text-align: center;" class="card-title">Migration to CMS Frameworks</h5>
                        <p class="card-text">Our experienced HTML5 programmers can help to migrate to CMS frameworks to
                            make you resilient in facing different technology changes. Hire our developers to migrate to
                            HTML 5 as we specialize in custom migration services.</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100">
                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                    <div class="card-body">
                        <h6 style="text-align: center;" class="card-title">HTML5 Mobile Application Development</h6>
                        <p class="card-text">Our HTML developers are proficient in HTML5 based hybrid mobile app
                            development. Being experienced in latest CSS3 features for animations and graphics, our web
                            designers can offer an in-depth app experience for both Android and iOS users.</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100">
                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                    <div class="card-body">
                        <h6 style="text-align: center;" class="card-title">HTML5 Support & Maintenance</h6>
                        <p class="card-text">Our reliable support & maintenance HTML5 development team has gained huge
                            expertise in maintaining web applications. Maintenance is key to run a profitable business
                            in the long run amid competitive world.</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100">
                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                    <div class="card-body">
                        <h6 style="text-align: center;" class="card-title">HTML5 UI Widget Developments</h6>
                        <p class="card-text">Our HTML developers can make interactive data visualizations using HTML5
                            and JavaScript, which can be implemented in rich web applications that look native on any
                            gadget or platform..</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100">
                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                    <div class="card-body">
                        <h6 style="text-align: center;" class="card-title">Progressive Web-apps</h6>
                        <p class="card-text">Hire dedicated HTML5 developers who are experienced in building cost
                            effective and scalable progressive web applications that run seamlessly across devices.</p>
                        </div>
                    </div>
                  </div>
              </div>
                ...
                <div class="row footer-widget-wrapper">
                    <div class="col-lg-4 col-md-6 col-sm-6 footer-widget">
                        ...
                        <ul class="footer-widget__list">
                            <li>IT Park Road, Near Persistent, Gayatri Nagar, Nagpur, Maharashtra 440022
                            </li>
                            <li><a href="mailto:contact@aeroland.com"
                                    class="hover-style-link">info@avestantechnologies.com</a></li>
                            <li><a href="tel:123344556"
                                    class="hover-style-link text-black font-weight--bold">+91 8381009662</a></li>
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 footer-widget">
                        ...
                        <ul class="footer-widget__list">
                            <li><a href="#" class="image_btn"><img class="img-fluid"
                                        src="assets/images/icons/aeroland-button-google-play.webp" alt=""></a></li>
                            <li><a href="#" class="image_btn"><img class="img-fluid"
                                        src="assets/images/icons/aeroland-button-app-store.webp" alt=""></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 text-center text-md-start">
                        <span class="copyright-text">&copy; 2022 Avestan Technologies. <a
                                href="https://hasthemes.com/">All Rights Reserved.</a></span>
                    </div>
                    <div class="col-md-6 text-center text-md-end">
                        <ul class="list ht-social-networks solid-rounded-icon">
                            ...
                            <li class="item">
                                <a href="https://m.facebook.com/avestantechnologies/" target="_blank" aria-label="Facebook"
                                    class="social-link hint--bounce hint--top hint--primary">
                                    <i class="fab fa-facebook-f link-icon"></i>
                                </a>
                            </li>
                            <li class="item">
                                <a href="https://www.instagram.com/avestantechnologies/" target="_blank" aria-label="Instagram"
                                    class="social-link hint--bounce hint--top hint--primary">
                                    <i class="fab fa-instagram link-icon"></i>
                                </a>
                            </li>
                            <li class="item">
                                <a href="https://in.linkedin.com/company/avestan-technologies/" target="_blank" aria-label="Linkedin"
                                    class="social-link hint--bounce hint--top hint--primary">
    ...
    <div class="demo-option-container">
        ...
        <div class="aeroland__toolbar">
            <div class="inner">
                ...
                <a class="hint--bounce hint--left hint--black primary-color-hover-important" target="_blank"
                    href="www.avestantechnologies.com"
                    aria-label="Website">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="element-flexible-image-slider.php"><span>Flexible image
                                                    slider</span></a></li>
                                ...
                                <li class="has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="element-carousel-sliders.php"><span>Carousel Sliders</span></a>
                                        </li>
...
<!-- Mirrored from htmldemo.net/mitech/element-buttons.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Aug 2022 14:10:44 GMT -->
