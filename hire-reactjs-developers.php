...
<!-- Mirrored from htmldemo.net/mitech/element-accordion.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Aug 2022 14:10:43 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="container margin">
             ...
             <div class="container-fluid">
                 <div class="col-md-6 col-lg-7 px-xl-0 text-white">
                     <h1 class="text-capitalize mb-0 text-white"><strong>Hire Highly Skilled &  Experienced ReactJS Developers</strong></h1>
                   ...
                   <div class="col-md-6 col-lg-5 ps-lg-5 text-center dform">
                     ...
                     <form action="insertdata21.php" method="post">
...
<h2 class="breadcrumb-title text-color-primary"  >Hire ReactJS Developers</h2><br>
<p class="lh-sm" style="font-size: 20px; text-align: center;">Get a simple and effective ReactJS website from Grawlix Software Private Limited <br> Top reasons to <b> Hire ReactJS Developers </b> with us.</p>

<!-- <div style="margin-top:35px ;"> -->
<ul>
    <li class="text-center" style="font-size: 20px;">We follow Agile Development</li>
    <li class="text-center" style="font-size: 20px;">Top Front-end/Backend Developers</li>
    <li class="text-center" style="font-size: 20px;">Possess Dynamic Skills</li>
    <li class="text-center" style="font-size: 20px;">Flexible Hiring Models</li>
    <li class="text-center" style="font-size: 20px;">Dedicated Resources</li>
    <li class="text-center" style="font-size: 20px;">One-to-one Communication</li>
</ul>
<!-- </div> -->
&nbsp;

<section>
    <h2 class="breadcrumb-title text-color-primary" >Our <b>Full-Stack ReactJs</b> Development Services</h2><br>
    <p class="lh-sm" style="font-size: 20px; text-align: center;">ReactJs is extremely extensible and works with a variety of libraries. This means you can fully <br>customize your workflow to achieve your business goals.</p><br>
    ...
    <div class="row row-cols-1 row-cols-md-2 g-4">
        <div class="col">
          <div class="card h-100">
            ...
            <div class="card-body" >
              <h5 style="text-align: center;" class="card-title">ReactJS Web App</h5>
              <p class="card-text" style="font-size: 18px;">We have experienced ReactJS developers who have delivered secure and dynamic software solutions for small to large businesses.</p>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card h-100">
            <!-- <img src="..." class="card-img-top" alt="..."> -->
            <div class="card-body" >
              <h5 style="text-align: center;" class="card-title">Customize ReactJS</h5>
              <p class="card-text" style="font-size: 18px;">Get all your requirements into a customized ReactJS solution with the help of our dedicated ReactJS programmers. Customize ReactJS Development</p>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card h-100">
            <!-- <img src="..." class="card-img-top" alt="..."> -->
            <div class="card-body" >
              <h5 style="text-align: center;" class="card-title">Dedicated ReactJS</h5>
              <p class="card-text" style="font-size: 18px;">If you are planning to have an experienced team of ReactJS, we have professional resources who will dedicatedly work on your project.</p>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card h-100">
            <!-- <img src="..." class="card-img-top" alt="..."> -->
            <div class="card-body" >
              <h5 style="text-align: center;" class="card-title">ReactJS UI/UX</h5>
              <p class="card-text" style="font-size: 18px;">Our skilled UI/UX team follows the standard process to deliver interactive app design along with a superior user experience.</p>
            </div>
          </div>
        </div>
        <div class="col">
            <div class="card h-100">
              <!-- <img src="..." class="card-img-top" alt="..."> -->
              <div class="card-body"  >
                <h5 style="text-align: center;" class="card-title">ReactJS Migration</h5>
                <p class="card-text"style="font-size: 18px;">We have integrated ReactJS to the existing web applications for the latest ReactJS framework without any data loss.</p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100">
              ...
              <div class="card-body" >
                ...
                <p class="card-text" style="font-size: 18px;">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
            </div>
        </div>
      </div>
  </div>
