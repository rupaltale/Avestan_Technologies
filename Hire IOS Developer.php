...
<body>
    ...
    <!--====================  End of header area  ====================-->
     <!-- Ragistration Form Area -->
    <div class="container-fluid bgcolor">
        <div class="container margin">
             <div class="row gy-3">
             <div class="container-fluid">
                 <div class="col-md-6 col-lg-7 px-xl-0 text-white">
                     <h1 class="text-capitalize mb-0 text-white"><strong>Hire Highly Skilled &  Experienced IOS Developers</strong></h1>
       ...
       <form class="form-horizontal finput"  action="insertdata2.php" method="post">
         <div class="form-group">
           <!-- <label class="control-label col-sm-2" for="email">Email:</label> -->
           <div class="col-sm-10">
             <input type="text" class="form-control input-lg" id="name" placeholder="Full Name" name="fullname">
           </div>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">        
           <div class="col-sm-offset-2 col-sm-10">
             <button type="submit" class="btn-md btn-default dbtn">Submit</button>
           </div>
         </div>
       </form>
         </div>          
            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb_box text-center">
                        <h1 class="breadcrumb-title text-color-primary"> Hire IOS Developer</h1>
                        <!-- breadcrumb-list start -->
                        <p>The number of iPhone users across the world is expected to cross the billion marks. Make the
                            most of this technology to optimize your business and attract customers from the world. Hire
                            iPhone developer from Avestan Technologies for iPhone mobile app development
                            services that put your business on the global map..</p>
                        ...
                        <div class="row row-cols-1 row-cols-md-3 g-4">
                            <div class="col">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title"> iPhone App UX/UI Design</h5>
                                        <p class="card-text">


                                            The iPhone app UI/UX service we offer will be designed by our experienced
                                            team of designers for a responsive app design..</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card h-100">
                                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                                    <div class="card-body">
                                        <h5 class="card-title"> iPhone Game Development</h5>
                                            <p class="card-text">


                                                As an experienced iOS game development company, we have delivered
                                                multiple 2D and 3D games that are loved by end-users.
                            ...
                            <div class="col">
                                <div class="card h-100">
                                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                                    <div class="card-body">
                                        <h5 class="card-title"> Custom iPhone App development</h5>
                                        <p class="card-text">



                                            Our iPhone app development team will help you materialize your app idea into
                                            a successful and real-life app that stands out in the App Store.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card h-100">
                                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                                    <div class="card-body">
                                        <h5 class="card-title"> IoT Powered iPhone Apps</h5>
                                        <p class="card-text">



                                            Our developers are ready to offer the best support and maintenance services
                                            that gives high-performance meeting all your business needs.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card h-100">
                                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                                    <div class="card-body">
                                        <h5 class="card-title"> iPhone Maintenance Optimisation</h5>
                                        <p class="card-text">



                                            We offer iPhone app maintenance and optimization ranging from small to
                                            enterprise level app providing you with excellent app performance.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            ...
                                            Get feature-rich iPhone watch app development from us. We conduct research
                                            and wide use of the Watch Kit SDK for effective application.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
