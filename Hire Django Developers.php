...
<body>
        ...
        <div class="container margin">
             ...
             <div class="container-fluid">
                 <div class="col-md-6 col-lg-7 px-xl-0 text-white">
                     <h1 class="text-capitalize mb-0 text-white"><strong>Hire Highly Skilled &  Experienced Django Developers</strong></h1>
                   ...
                   <div class="col-md-6 col-lg-5 ps-lg-5 text-center dform">
                     ...
                     <form action="insertdata6.php" method="post">
 ...
 <!--====================  End of Ragistration area  ====================-->
    ...
    <section style="margin: 30px;">
        ...
        <h2  class="breadcrumb-title text-color-primary" >Hire Django Developers</h2><br>
       <p class="lh-sm" style="font-size: 20px; text-align: justify;">Django is an open-source framework that enables developers to create web applications that are secure as well as scalable. Whether you are an entrepreneur, a small business, or an established organization, Django has the features to accommodate all your business requirements in the form of a powerful web application. If you are planning your next web application on this Python-based framework, then Kanhasoft is the Django Development Company worth considering. Handpick the team of Django Developers to work on your project and monitor the development process with 100% transparency using Time Doctor software. To hire Django Developers in India, get in touch.</p>
       <p  class="lh-sm" style="font-size: 20px; text-align: justify;">Hire Django Programmers in India from Kanhasoft having years of experience in Django web app development and other associated technologies required to create a highly scalable solution. We hold proficiency in creating simple to complex web applications using Django. From the healthcare industry to the restaurant industry and from customer service portals to law service portals, our portfolio is a collection of a wide range of solutions and services we offer to our clients globally.   </p>
   
      
    <section style="margin: 30px;">
        <h2  class="breadcrumb-title text-color-primary">Hire Django Developers in India for:</h2>&nbsp;
        ...
        <div class="row row-cols-1 row-cols-md-2 g-4">
            <div class="col">
              <div class="card">    
                ...
                <div class="card-body" >
                  <h5 style="text-align: center;" class="card-title">Bespoke Web Applications</h5>
                  <p class="card-text" id="para" style="font-size: 18px;">Get a web application that is purposely designed and developed for your business and to solve real-time business challenges.</p>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card">
                <!-- <img src="..." class="card-img-top" alt="..."> -->
                <div class="card-body" >
                  <h5 style="text-align: center;" class="card-title">SaaS-based Solutions</h5>
                  <p class="card-text" id="para" style="font-size: 18px;">Hire Django developers to create SaaS-Based web applications that can address the problem of the masses.</p>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card">
                <!-- <img src="..." class="card-img-top" alt="..."> -->
                <div class="card-body" >
                  <h5 style="text-align: center;" class="card-title" >Web Application Assistance</h5>
                  <p class="card-text" id="para" style="font-size: 18px;">Post-development support is the specialty of Django Developers at Kanhasoft. We offer 100% professional support <services class=""></services></p>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card">
                <!-- <img src="..." class="card-img-top" alt="..."> -->
                <div class="card-body" >
                  <h5 style="text-align: center;" class="card-title" >Legacy App Re-Development</h5>
                  <p class="card-text" id="para" style="font-size: 18px;">Post-development support is the specialty of Django Developers at Kanhasoft. We offer 100% professional support services.</p>
                </div>
            </div>
          </div>
      </div>
