    ...
    <div class="container margin">
         ...
         <div class="container-fluid">
             <div class="col-md-6 col-lg-7 px-xl-0 text-white">
                 <h1 class="text-capitalize mb-0 text-white"><strong>Hire Highly Skilled &  Experienced Xamarin Developers</strong></h1>
               ...
               <div class="col-md-6 col-lg-5 ps-lg-5 text-center dform">
                 ...
                 <form action="insertdata16.php" method="post">
...
<!--====================  End of Ragistration area  ====================-->
     ...
     <section style="margin: 30px;">
        ...
        <h2 class="breadcrumb-title text-color-primary" >HIRE XAMARIN DEVELOPER</h2><br>
       <p class="lh-sm" style="font-size: 20px; text-align: justify;">Xamarin is an ideal tool to make your clients explore your business via cross platform mobile app. Hire Xamarin developer from Clarion to build, publish and manage native high-quality applications with lesser runtime .</p>
      <ul>
        <li style="font-size: 23px;">97%+ Client Retention Rate</li>
        <li style="font-size: 23px;">Complete Control Over Team</li>
        <li style="font-size: 23px;">Agile & adoptive development</li>
        <li style="font-size: 23px;">Quick & easy onboarding</li>
        <li style="font-size: 23px;">Expertise in varied Technologies</li>
        <li style="font-size: 23px;">Quality Assurance & Quick Turnaround Time</li>
      </ul>
   
    <section style="margin: 30px;">
        <h2 class="breadcrumb-title text-color-primary">OUR XAMARIN EXPERTISE</h2>
        <p class="lh-sm" style="font-size: 20px; text-align: justify;">
            We have a team of Xamarin developers who possess excellent knowledge of Xamarin technology to build effective native applications for Android, iOS, and Windows. We are engaged in the following Xamarin services:
        </p>&nbsp;
        <div class="row row-cols-1 row-cols-md-2 g-4">
            <div class="col">
              <div class="card h-100">
                ...
                <div class="card-body" >
                  <h5 style="text-align: center;" class="card-title">XAMARIN APP DEVELOPMENT</h5>
                  <p class="card-text" id="para" style="font-size: 18px;">Our team of Xamarin developers is proficient in Xamarin iPhone development and deliver Xamarin iOS app on a shared C# codebase with the same language, IDE, and APIs to the global clients. They are also specialized in Xamarin Android development with native UI & performance.</p>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card h-100">
                <!-- <img src="..." class="card-img-top" alt="..."> -->
                <div class="card-body" >
                  <h5 style="text-align: center;" class="card-title">UI/UX DESIGN FOR XAMARIN APPS</h5>
                  <p class="card-text" id="para" style="font-size: 18px;">Our UI/UX experts with pre-loaded knowledge on Xamarin app development can find the right balance between engaging programmer’s and UI’s needs to develop versatile applications that stand out.</p>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card h-100">
                <!-- <img src="..." class="card-img-top" alt="..."> -->
                <div class="card-body" >
                  <h5 style="text-align: center;" class="card-title" >MIGRATION TO XAMARIN</h5>
                  <p class="card-text" id="para" style="font-size: 18px;">Some apps are developed in a native mobile language and now it is time to convert them into Xamarin. Our experienced Xamarin app developers are experts in migration services and ensure a smooth transition of your applications to Xamarin from other stacks.</p>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card h-100">
                <!-- <img src="..." class="card-img-top" alt="..."> -->
                <div class="card-body" >
                  <h5 style="text-align: center;" class="card-title" >XAMARIN TESTING SERVICE</h5>
                  <p class="card-text" id="para" style="font-size: 18px;">Our mobile testing and QA experts are well versed in understanding the code written by Xamarin developers. They can ensure high-quality Xamarin apps are released with the help of automation capabilities of Xamarin Test Cloud.</p>
                </div>
            </div>
          </div>
      </div>
