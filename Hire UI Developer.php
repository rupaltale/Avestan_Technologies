        ...
        <div class="container margin">
             ...
             <div class="container-fluid">
                 <div class="col-md-6 col-lg-7 px-xl-0 text-white">
                     <h1 class="text-capitalize mb-0 text-white"><strong>Hire Highly Skilled &  Experienced UI & UX Developers</strong></h1>
                   ...
                   <div class="col-md-6 col-lg-5 ps-lg-5 text-center dform">
                     ...
                     <form action="insertdata15.php" method="post">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb_box text-center">
                        <h1 class="breadcrumb-title text-color-primary"> Hire UI/UX Developer</h1><br>
                        <!-- breadcrumb-list start -->
                        <p>Our designers are known for their out-of-the-box thinking and tech-savviness. Whether you need a minimalist website or a design-heavy mobile app, the design team meets all your unique needs. Our designers exhibit all the hallmark qualities expected in a masterful designer.</p>
                        ...
                        <div class="row row-cols-1 row-cols-md-3 g-4">
                            <div class="col">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">  Tech-Savvy Designers</h5>
                                        <p class="card-text">

                                           
                                            
                                            The design team uses the most advanced tools and technologies to create highly personalized designs for clients. They’re always updated about design trends in the market.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            ...
                                            Our designers are known for demonstrating outstanding creativity in all the solutions. They blend the most attractive design elements with the technical elements of a solution.
                            ...
                            <div class="col">
                                <div class="card h-100">
                                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                                    <div class="card-body">
                                        <h5 class="card-title"> Design Veterans</h5>
                                        <p class="card-text">


                                            
                                            
                                            With years of experience in web and mobile app design, our designers can quickly understand all your needs. Their diverse experience enables them to take an insights-driven approach to design.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card h-100">
                                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                                    <div class="card-body">
                                        <h5 class="card-title"> Effortless Communication</h5>
                                        <p class="card-text">


                                            
                                            
Communication is key when it comes to delivering exactly what a client wants. Our designers have impressive communication skills that help them to work perfectly in sync with clients’ expectations.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            ...
                                            Teamwork is extremely important for creating outstanding design and delivering a flawless solution. From working as a team at Avestan Technologies to collaborating with clients’ teams, the designers are good at every team effort.
                            ...
                            <div class="col">
                                <div class="card h-100">
                                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                                    <div class="card-body">
                                        <h5 class="card-title">Quality-first Approach</h5>
                                        <p class="card-text">
                                           
                                            
                                            
                                            Every design created at Avestan Tchnologies gets meticulous efforts to ensure superior quality. The designers adhere to international quality standards and best practices.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
