...
<body>
                ...
                <div class="col-12">
                    <div class="breadcrumb_box text-center">
                        ...
                        <ul class="breadcrumb-list">
                            <!-- <p style="text-align: justify;" >We search for outliers, out-of-box thinkers and over achievers. if this defines you then -->
                                <!-- its time we connected to discuss our future together.</p> -->
    ...
    <div id="main-wrapper">
        <div class="site-wrapper-reveal">
            ...
            <div class="careers-experts-wrapper section-space--pt_98">
                <div class="container">
                    <div class="row">
                                ...
                                <div clas="list">
                                    ...
                                    <div class="item">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="job-info">
                                                    <h5 class="job-name">React JS <br> Developer </h5>
                                                    <span class="job-time">Full time</span>
                                                </div>
                                            </div>

                                            <div class="col-md-6">
                                                <div style="text-align: justify;" class="job-description">React JS Development Company which provides you ReactJS Website and Mobile Application development services. Our ReactJS developers design the interface which mesmerizes the user and gives them an overwhelming experience and simplify the application development easily.</div>
                                            </div>
                                    ...
                                    <div class="item">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="job-info">
                                                    <h5 class="job-name">MEAN Stack Developer</h5>
                                                    <span class="job-time">Full time</span>
                                                </div>
                                            </div>

                                            <div class="col-md-6">
                                                <div style="text-align: justify;" class="job-description">This technology makes the development process easier and creates interactive applications possible within a budget. We are equipped with the components of this technology that helps with ease of development and flexibility for creating the best JavaScript-based applications.</div>
                                            </div>
                    ...
                    <div class="row footer-widget-wrapper">
                        <div class="col-lg-4 col-md-6 col-sm-6 footer-widget">
                            ...
                            <ul class="footer-widget__list">
                                ...
                                <li><a href="https://hasthemes.com/" class="hover-style-link text-color-primary">www.avestantechnologies.com</a></li>
                            </ul>
                        </div>
    ...
    <div class="demo-option-container">
        ...
        <div class="demo-option-wrapper">
            <div class="demo-panel-header">
                <div class="title">
                    <h6 class="heading mt-30">IT Solutions Avestan - Technology, IT Solutions & Services Html5 Template</h6>
                </div>
...
<!-- Mirrored from htmldemo.net/mitech/case-studies.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Aug 2022 14:10:57 GMT -->
</html>