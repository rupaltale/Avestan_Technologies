        ...
        <div class="container margin">
             ...
             <div class="container-fluid">
                 <div class="col-md-6 col-lg-7 px-xl-0 text-white">
                     <h1 class="text-capitalize mb-0 text-white"><strong>Hire Highly Skilled &  Experienced Software Tester Developers</strong></h1>
                   ...
                   <div class="col-md-6 col-lg-5 ps-lg-5 text-center dform">
                     ...
                     <form action="insertdata23.php" method="post">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb_box text-center">
                        <h1 class="breadcrumb-title text-color-primary">Hire Software Developer</h1> <br>
                        <!-- breadcrumb-list start -->
                        <p>
                            At Grawlix Software Private Limited, we bring the value to your product and ensure its
                            secure, efficient and trustworthy with our different Software Testing Services, and QA
                            services methodologies.</p> <br>
                        ...
                        <div class="row row-cols-1 row-cols-md-3 g-4">
                            <div class="col">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h5 class="card-title">Functional Testing</h5>
                                        <p class="card-text">


                                            The functional tests verify that each component or system operates in
                                            conformance with the requirement specification. Our functional testing
                                            services focus on ensuring the functionality, reliability, and stability of
                                            a product/service before it enters the production phase.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card h-100">
                                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                                    <div class="card-body">
                                        <h5 class="card-title">Security Testing And Load Testing</h5>
                                        <p class="card-text"> 


                                            It verifies software security and determines how a software program performs
                                            when many users access your software. We provide a deep insight into the
                                            state of your IT environment cybersecurity and comprehensive recommendations
                                            on how to make it hack-proof.
                            ...
                            <div class="col">
                                <div class="card h-100">
                                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                                    <div class="card-body">
                                        <h5 class="card-title">Compatibility Testing</h5>
                                        <p class="card-text"> It ensures that your product is capable enough to run in various databases,
                                            browsers, OS, hardware, network, and mobile devices. Our professionals
                                            perform every type of compatibility testing that you would prefer as per
                                            your requirements of Compatibility Test. software is capable different
                                            hardware,</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title"> Usability Testing</h5>
                                         <p class="card-text"> Usability testing is used to evaluate your product or app with real users to
                                            see where they face any problems and experience confusion. With usability
                                            testing services, we identify all the usability issues before the
                                            application is released, providing an intuitive user experience. 
                                         </p> 
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"> Units have to be tested integrating them into larger modules and groups that
                                            carry out designated tasks, making sure they do so accordingly. We offer
                                            integration testing services for your business irrespective of any industry
                                            with end-to-end services using real test cases.
                                        </p> 
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="card h-100">
                                    <!-- <img src="..." class="card-img-top" alt="..."> -->
                                    <div class="card-body">
                                        <h5 class="card-title">Acceptance Testing</h5>
                                            <p class="card-text">
                                                User acceptance testing is the final step in software testing services,
                                                emulating real-world usage conditions before a software application is
                                                released to end-users. It is used to perform to double-check the performance
                                                of final product as per pre-established criteria. Testing and before the
