        ...
        <div class="container margin">
             ...
             <div class="container-fluid">
                 <div class="col-md-6 col-lg-7 px-xl-0 text-white">
                     <h1 class="text-capitalize mb-0 text-white"><strong>Hire Highly Skilled &  Experienced Codelgniter Developers</strong></h1>
        ...
        <div class="row row-cols-1 row-cols-md-2 g-4">
            <div class="col">
              <div class="card">    
                ...
                <div class="card-body" >
                  <h5 style="text-align: center;" class="card-title">Bespoke Business Web Applications</h5>
                  <p class="card-text" id="para" style="font-size: 18px;">Own a personalized business application that is solely designed and developed keeping your business requirements in mind.</p>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card">
                ...
                <div class="card-body" >
                  ...
                  <p class="card-text" id="para" style="font-size: 18px;">We provide end-to-end SaaS-based app design and Software development solutions that can efficiently address the problem of the mass.</p>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card">
                <!-- <img src="..." class="card-img-top" alt="..."> -->
                <div class="card-body">
                  <h5 style="text-align: center;" class="card-title" >Legacy Application Re-development & Maintenance</h5>
                  <p class="card-text" id="para" style="font-size: 18px;">Timely maintenance and upgrade of your existing application are extremely important for optimum functioning. Contact our team for app re-development and maintenance.</p>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card">
                <!-- <img src="..." class="card-img-top" alt="..."> -->
                <div class="card-body" >
                  <h5 style="text-align: center;" class="card-title" >Develop customized responsive web application</h5>
                  <p class="card-text" id="para" style="font-size: 18px;">We develop responsive web app with flexible layouts that easily adapt to the screen size and offer the best browsing experience to your clients.</p>
                </div>
            </div>
          </div>
      </div>
