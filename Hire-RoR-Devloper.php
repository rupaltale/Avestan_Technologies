...
<!-- Mirrored from htmldemo.net/mitech/element-box-large-image.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Aug 2022 14:10:43 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="container margin">
             ...
             <div class="container-fluid">
                 <div class="col-md-6 col-lg-7 px-xl-0 text-white">
                     <h1 class="text-capitalize mb-0 text-white"><strong>Hire Highly Skilled &  Experienced RoR Developers</strong></h1>
                   ...
                   <div class="col-md-6 col-lg-5 ps-lg-5 text-center dform">
                     ...
                     <form action="insertdata22.php" method="post">
...
<section style="margin: 40px; ">
    ...
    <h2 class="breadcrumb-title text-color-primary">Hire Dedicated RoR Developer</h2><br>
    <p  class="lh-sm" style="font-size: 20px; text-align: justify;">Hire our RoR developers, and they will do the job efficiently according to your business requirements. Atharva System offer flexible hiring of developers that provide flexible solutions for our clients’ requirements.
    </p>


<section>
<div class="img" >
  <img height="400px" src="assets/img/hire-resouces-ror-report.webp">
</div>
<!-- <div>
   <p style="font-size: 20px;">Atharva System offers some of the best dedicated Ruby on Rails (RoR) Developers. Our programming team absorbs the requirements in creative and logical manner. We can create dynamic and customer-centric Ruby on Rails web solutions for your business. Atharva System uses the latest RoR practices, and carefully study every angle of the new technology before implementing it. Hire RoR developers with us, and you will feel the benefits of our Rubi on Rails specialists.</p> 
</div>
<div>
    <p style="font-size: 20px;">We can assist you in creating the best RoR solutions for your business needs. Atharva System will convert your ideas into successful projects. Hire Ruby on Rails developers with us, and you will get a reliable development service with fast turnaround times. We offer you an opportunity to hire RoR developers who are well-trained and professional in delivering high-quality, innovative results. With our expertise in Ruby on Rails development, we ensure quality solutions, timely delivery, and affordable prices.</p>
</div> -->
&nbsp;

<section style="margin: 30px;">
    <h3 class="breadcrumb-title text-color-primary">Hiring Dedicated Ruby on Rails developer
      <b> Advantages</b> </h3><br>
      <p  class="lh-sm" style="font-size: 20px; text-align: justify;">With an easy to hire process and affordable, fast, and high-quality development services we offer you a chance to stand out from the crowd and get your perfect RoR solutions. These are the benefits of hiring Ruby on Rails developer. </p>&nbsp;
      <div class="card-group">
        <div class="card body" >
          <!-- <img src="..." class="card-img-top" alt="..."> -->
          <div class="card-body" >
            <!-- <h5 class="card-title">Card title</h5> -->
            <p class="card-text" style="font-size: 20px;" >Proven RoR development processes and matured project management practices</p>
        ...
        <div class="card" style="  border-style: solid; ">
          ...
          <div class="card-body ">
            <!-- <h5 class="card-title">Card title</h5> -->
            <p class="card-text" style="font-size: 20px;">Collaboration with highly professional Ruby on Rails Developers
            </p>
            <!-- <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p> -->
          </div>
        </div>
        <div class="card">
          ...
          <div class="card-body" >
            <!-- <h5 class="card-title">Card title</h5> -->
            <p class="card-text" style="font-size: 20px;">RoR development service suitable for all kind of businesses</p>
            <!-- <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p> -->
          </div>
        </div>
        <div class="card">
            ...
            <div class="card-body" >
              <!-- <h5 class="card-title">Card title</h5> -->
              <p class="card-text" style="font-size: 20px;">Regular working reports for the project progress</p>
              <!-- <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p> -->
            </div>
          </div>
          <div class="card">
            ...
            <div class="card-body" >
              <!-- <h5 class="card-title">Card title</h5> -->
              <p class="card-text" style="font-size: 20px;">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
              <!-- <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p> -->
            </div>
          </div>
          <div class="card">
